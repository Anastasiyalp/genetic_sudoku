...
# difficalty = {'1': ['s01a.txt', 's01b.txt', 's01c.txt'], '2': ['s02a.txt', 's02b.txt', 's02c.txt'], '3': ['s03a.txt', 's03b.txt', 's03c.txt'], '4': ['s04a.txt', 's04b.txt', 's04c.txt'], '5': ['s05a.txt', 's05b.txt', 's05c.txt'], 'E': ['s06a.txt', 's06b.txt', 's06c.txt'], 'C': ['s07a.txt', 's07b.txt', 's07c.txt'], 'D': ['s08a.txt', 's08b.txt', 's08c.txt'], 'SD': ['s09a.txt', 's09b.txt', 's09c.txt'], 'Easy': ['s10a.txt', 's10b.txt', 's10c.txt'], 'Medium': ['s11a.txt', 's11b.txt', 's11c.txt'], 'Hard': ['s12a.txt', 's12b.txt', 's12c.txt'], 'GA-E': ['s13a.txt', 's13b.txt', 's13c.txt'], 'GA-M': ['s14a.txt', 's14b.txt', 's14c.txt'], 'GA-H': ['s15a.txt', 's15b.txt', 's15c.txt'], 'AI Escargot': ['s16.txt']}
...
format_result = map(union, [[y for y in results if y[0]==x] for x in sudoku_numbers.keys()])
...
plt.scatter(sudoku_numbers.values(), numpy.array(format_result[1]).astype(int)/numpy.array(format_result[2]).astype(float))
...
plt.ylabel('Generations / time')
plt.xlabel('Number of empty cell')
